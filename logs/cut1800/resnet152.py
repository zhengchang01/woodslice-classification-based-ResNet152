...
model_cfg = dict(
    ...
    head=dict(
        type='LinearClsHead',
        num_classes=16, # your training classes
        in_channels=2048,
...
data_cfg = dict(
    ...
    train = dict(
        ...
        pretrained_weights = 'datas/resnet152_8xb32_in1k_20210901-4d7582fa.pth',
        freeze_flag = False,
        freeze_layers = ('backbone',),
        epoches = 100,
    ),
    test=dict(
        ckpt = 'logs/ResNet/cut1600_c1000/Val_Epoch093-Acc94.288.pth',
